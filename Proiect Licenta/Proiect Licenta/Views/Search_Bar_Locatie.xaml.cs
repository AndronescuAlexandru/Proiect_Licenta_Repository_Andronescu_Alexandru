...
namespace Proiect_Licenta.Views
{
    ...
    public partial class Search_Bar_Locatie : ContentPage
    {
        string[] locatii =
        {
        ...
        void SearchButtonPressedPlecare(object sender, System.EventArgs e)
        {
            ...
            //SearchList.ItemsSource = locatii.Where(c => c.Contains(Locatie_Plecare.Text));
        ...
        /*void SearchButtonPressedDestinatie(object sender, System.EventArgs e)
        {
            ...
            Mesager.Destinatie = Locatie_Destinatie.Text;
        }*/
        void SearchResultsClicked(object sender, System.EventArgs e)
        {
            var button = (Button)sender;
            Mesager.Plecare = button.Text;
            Navigation.PopAsync();
        }
        public Search_Bar_Locatie()
        {
            InitializeComponent();
        }
    }
